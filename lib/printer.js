...
} else if (fs.existsSync('./printerData/node_printer.node')) {
	console.log('Relative path detected')
	printer_helper = require( path.resolve(process.cwd(),'./printerData/node_printer.node') );  // fs is different from require(), use pathresolve to get absolute
 }else {
